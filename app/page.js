...
<section className="work" id="work"><article className="project bbs bbs-image-led"><div className="project-copy"><p className="section-label">02 / STRATEGY</p><h2>Be BiteSmart</h2><p>Be BiteSmart is a child-safety education programme helping families understand safer interactions between children and dogs.</p><p>I developed a parent-first digital strategy that reorganised its educational resources around real parent needs.</p><div className="tags"><span>DIGITAL STRATEGY</span><span>USER JOURNEYS</span><span>CONTENT STRATEGY</span></div><a className="case-link" href="/work/be-bitesmart">VIEW CASE STUDY <b>↗</b></a></div><figure className="bbs-home-image bbs-feature-image"><img src="https://images.pexels.com/photos/7677733/pexels-photo-7677733.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Parent and child interacting with a family dog"/><figcaption>PARENT-FIRST / CHILD SAFETY</figcaption></figure></article>
